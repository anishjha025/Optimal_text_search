...
{
    fstream f1;
    f1.open("/home/anish/QT/Text_search/permut.txt",fstream::in |fstream::out |fstream::app);
   // f1<<a<<endl;
    while(!s1.empty())
    {
        f1<<*s1.begin()<<endl;
...
int search(char *str)
{
    FILE *file1=fopen("/home/anish/QT/Text_search/file1.txt","r");
    char line[128];
    int i;
    for(i=0;i<128;i++)
    {
...
void naive::on_pushButton_clicked()
{
    ...
    arr1[i]='\0';
    fstream f1;
    f1.open("/home/anish/QT/Text_search/permut.txt",fstream::out |fstream::trunc);
    f1.close();
...
void naive::on_pushButton_2_clicked()
{
    ...
    begin=clock();
    FILE *file2=fopen("/home/anish/QT/Text_search/permut.txt","r");
    char line[128];
    int i;
    for(i=0;i<128;i++)
    {
